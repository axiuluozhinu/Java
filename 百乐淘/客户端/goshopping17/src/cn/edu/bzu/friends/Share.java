...
public class Share extends ListActivity implements OnItemClickListener{
	 ...
	 Consumer consumer=new Consumer();
	  ...
	  public void onCreate(Bundle savedInstanceState) {
	    	...
	    	setContentView(R.layout.more);
	         ...
	         Goods[] goods=friendsdata.viewShareGooods(data);
	    	 length=goods.length;
	    	...
	    	setListAdapter(new SimpleAdapter(Share .this, getDate(), 
	    ...
	    private OnClickListener menu=new OnClickListener() {
			...
			switch (menu.getId()) {
			case R.id.menu1:
				Intent intent1=new Intent(Share.this,Index.class);
				intent1.putExtra("tltle", "首页");
				startActivity(intent1);				
				break;		
			case R.id.menu2:
				Intent intent2=new Intent(Share.this,Type.class);
				intent2.putExtra("tltle", "分类");
				startActivity(intent2);					
				break;
			case R.id.menu3:
				Intent intent3=new Intent(Share.this,StoresType.class);
				intent3.putExtra("tltle", "商家列表");
				startActivity(intent3);					
				break;
			case R.id.menu4:
				Intent intent4=new Intent(Share.this,Maps.class);
				intent4.putExtra("tltle", "百乐淘");
				startActivity(intent4);					
				break;
			case R.id.menu5:
				Intent intent5=new Intent(Share.this,More.class);
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			for (int i = 0; i < BOYTYPE.length; i++) {
				if(i==arg2){
					Intent intent1=new Intent(Share.this,GoodsIntroduce.class);
					intent1.putExtra("index",goodsid[i]);
					startActivity(intent1);		
			}}
...
//			
//				if(arg2==0){
//					Intent intent1=new Intent(Share .this,Goods_Rank_Show.class);
//					startActivity(intent1);		
//			}
//		if(arg2==1){
//					Intent intent1=new Intent(Share .this,Goods_Rank_Show.class);
...
//			}
//		if(arg2==3){
//			Intent intent5=new Intent(Share .this,Goods_Rank_Show.class);
//			startActivity(intent5);
//		}
//			
//		}
