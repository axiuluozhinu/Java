...
public class Chat extends ListActivity implements OnItemClickListener{
...
created. */
	 ListView listViewAll;
	  ...
	  public void onCreate(Bundle savedInstanceState) {
	    	...
	    	setListAdapter(new SimpleAdapter(Chat.this, getDate(), R.layout.common_listview_text, 
	    ...
	    private OnClickListener menu=new OnClickListener() {
			...
			switch (menu.getId()) {
			case R.id.menu1:
				Intent intent1=new Intent(Chat.this,Index.class);
				intent1.putExtra("tltle", "首页");
				startActivity(intent1);				
				break;		
			case R.id.menu2:
				Intent intent2=new Intent(Chat.this,Type.class);
				intent2.putExtra("tltle", "分类");
				startActivity(intent2);					
				break;
			case R.id.menu3:
				Intent intent3=new Intent(Chat.this,StoresType.class);
				intent3.putExtra("tltle", "商家列表");
				startActivity(intent3);					
				break;
			case R.id.menu4:
				Intent intent4=new Intent(Chat.this,Maps.class);
				intent4.putExtra("tltle", "百乐淘");
				startActivity(intent4);					
				break;
			case R.id.menu5:
				Intent intent5=new Intent(Chat.this,More.class);
		...
		static final String[] BOYTYPE = {"好友分享","添加好友","好友列表"};
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			
			if(arg2==0){
					Intent intent1=new Intent(Chat.this,FriendsSharelist.class);
					startActivity(intent1);		
			}
		
				if(arg2==1){
					Intent intent1=new Intent(Chat.this,AddFriends.class);
					startActivity(intent1);		
			}
		if(arg2==2){
			Intent intent5=new Intent(Chat.this,FriendList.class);
			startActivity(intent5);
		}
