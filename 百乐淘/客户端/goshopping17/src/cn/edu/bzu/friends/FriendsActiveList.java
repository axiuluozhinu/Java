...
public class FriendsActiveList extends ListActivity implements OnItemClickListener{
	 ...
	 Consumer consumer=new Consumer();	
	  ...
	  public void onCreate(Bundle savedInstanceState) {
	    	...
	    	BOYTYPE=friendsdata.friendActivity(Consumer.getClientAccount());	    	
	    	listViewAll= (ListView)findViewById(android.R.id.list);
	    	
	    	setListAdapter(new SimpleAdapter(FriendsActiveList.this, getDate(), R.layout.common_listview_text, 
	    ...
	    private OnClickListener menu=new OnClickListener() {
			...
			switch (menu.getId()) {
			case R.id.menu1:
				Intent intent1=new Intent(FriendsActiveList.this,Index.class);
				intent1.putExtra("tltle", "首页");
				startActivity(intent1);				
				break;		
			case R.id.menu2:
				Intent intent2=new Intent(FriendsActiveList.this,Type.class);
				intent2.putExtra("tltle", "分类");
				startActivity(intent2);					
				break;
			case R.id.menu3:
				Intent intent3=new Intent(FriendsActiveList.this,StoresType.class);
				intent3.putExtra("tltle", "商家列表");
				startActivity(intent3);					
				break;
			case R.id.menu4:
				Intent intent4=new Intent(FriendsActiveList.this,Maps.class);
				intent4.putExtra("tltle", "百乐淘");
				startActivity(intent4);					
				break;
			case R.id.menu5:
				Intent intent5=new Intent(FriendsActiveList.this,More.class);
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			for (int i = 0; i < BOYTYPE.length; i++) {
				if(i==arg2){
					Intent intent1=new Intent(FriendsActiveList.this,FriendsPart.class);
