...
public class FriendList extends ListActivity implements OnItemClickListener{
...
created. */
	 ...
	 Consumer consumer=new Consumer();	
	  ...
	  public void onCreate(Bundle savedInstanceState) {
	    	...
	    	setListAdapter(new SimpleAdapter(FriendList.this, getDate(), R.layout.common_listview_text, 
	    ...
	    private OnClickListener menu=new OnClickListener() {
			...
			switch (menu.getId()) {
			case R.id.menu1:
				Intent intent1=new Intent(FriendList.this,Index.class);
				intent1.putExtra("tltle", "首页");
				startActivity(intent1);				
				break;		
			case R.id.menu2:
				Intent intent2=new Intent(FriendList.this,Type.class);
				intent2.putExtra("tltle", "分类");
				startActivity(intent2);					
				break;
			case R.id.menu3:
				Intent intent3=new Intent(FriendList.this,StoresType.class);
				intent3.putExtra("tltle", "商家列表");
				startActivity(intent3);					
				break;
			case R.id.menu4:
				Intent intent4=new Intent(FriendList.this,Maps.class);
				intent4.putExtra("tltle", "百乐淘");
				startActivity(intent4);					
				break;
			case R.id.menu5:
				Intent intent5=new Intent(FriendList.this,More.class);
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			for (int i = 0; i < BOYTYPE.length; i++) {
				if(i==arg2){
					Intent intent1=new Intent(FriendList.this,Friendsinformation.class);
