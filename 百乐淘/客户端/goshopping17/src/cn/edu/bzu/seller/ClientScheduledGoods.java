...
public class ClientScheduledGoods extends ListActivity implements OnItemClickListener {
	  ...
	  public void onCreate(Bundle savedInstanceState) {
	    	...
	    	String data=null;
			 Bundle extras = getIntent().getExtras();
		        ...
		        Goods[] goods=businessdata.localClientScheduledGoods(Business.getBusinessAccount(), data); 
		        length=goods.length;
		    	...
		    	for(int i=0;i<BOYTYPE.length;i++){
					...
					id[i]=Integer.parseInt(goods[i].getGoodsId());
				}
	    	...
	    	setListAdapter(new SimpleAdapter(ClientScheduledGoods.this, getDate(), 
	    ...
	    private OnClickListener menu=new OnClickListener() {
			...
			switch (menu.getId()) {
			case R.id.menu1:
				Intent intent1=new Intent(ClientScheduledGoods.this,Index.class);
				intent1.putExtra("tltle", "首页");
				startActivity(intent1);				
				break;		
			case R.id.menu2:
				Intent intent2=new Intent(ClientScheduledGoods.this,Type.class);
				intent2.putExtra("tltle", "分类");
				startActivity(intent2);					
				break;
			case R.id.menu3:
				Intent intent3=new Intent(ClientScheduledGoods.this,StoresType.class);
				intent3.putExtra("tltle", "商家列表");
				startActivity(intent3);					
				break;
			case R.id.menu4:
				Intent intent4=new Intent(ClientScheduledGoods.this,Maps.class);
				intent4.putExtra("tltle", "百乐淘");
				startActivity(intent4);					
				break;
			case R.id.menu5:
				Intent intent5=new Intent(ClientScheduledGoods.this,More.class);
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			for (int i = 0; i < BOYTYPE.length; i++) {
				if(i==arg2){
					Intent intent1=new Intent(ClientScheduledGoods.this,GoodsIntroduce.class);
