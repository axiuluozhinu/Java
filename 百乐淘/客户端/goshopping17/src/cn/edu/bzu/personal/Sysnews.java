...
public class Sysnews extends ListActivity implements OnItemClickListener{	  
		/** Called when the activity is first created. */
	ConsumerData consumerData=new ConsumerData();
	String[] str=consumerData.confirmFriend(Consumer.getClientAccount());
	String[] BOYTYPE = str;
	...
	String agree;
	  ...
	  public void onCreate(Bundle savedInstanceState) {	
	   ...
	   listViewAll= (ListView)findViewById(android.R.id.list);   
		setListAdapter(new SimpleAdapter(Sysnews.this, getDate(), 
	...
	switch (menu.getId()) {
	case R.id.menu1:
		Intent intent1=new Intent(Sysnews.this,Index.class);
		intent1.putExtra("tltle", "首页");
		startActivity(intent1);				
		break;		
	case R.id.menu2:
		Intent intent2=new Intent(Sysnews.this,Type.class);
		intent2.putExtra("tltle", "分类");
		startActivity(intent2);					
		break;
	case R.id.menu3:
		Intent intent3=new Intent(Sysnews.this,StoresType.class);
		intent3.putExtra("tltle", "商家列表");
		startActivity(intent3);					
		break;
	case R.id.menu4:
		Intent intent4=new Intent(Sysnews.this,Maps.class);
		intent4.putExtra("tltle", "百乐淘");
		startActivity(intent4);					
		break;
	case R.id.menu5:
		Intent intent5=new Intent(Sysnews.this,More.class);
...
public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
	...
	for (int i = 0; i < BOYTYPE.length; i++) {
		if(i==arg2){
//			Intent intent1=new Intent(ActNews.this,Show.class);
//			startActivity(intent1);
			if(BOYTYPE[i].equals("暂无消息")){
				break;
			}
			dialog();
...
protected void dialog() {
	  Builder builder = new Builder(Sysnews.this);
	  builder.setMessage("是否同意并添加对方为好友？");
	  ...
	  builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
	   ...
	   public void onClick(DialogInterface dialog, int whichButton) {
		   agree="Yes";
		   friendsData.agreeAdd(Consumer.getClientAccount(), agree);
		   dialog.dismiss();	    
	    Sysnews.this.finish();
	   }
	  });
